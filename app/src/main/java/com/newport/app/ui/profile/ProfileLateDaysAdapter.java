...
public class ProfileLateDaysAdapter extends RecyclerView.Adapter<ProfileLateDaysAdapter.LateItemViewHolder> {

    private final List<UserResponse.TardinessBean.EntryBean> tardinessBeanList;

    public ProfileLateDaysAdapter() {
        this.tardinessBeanList = new ArrayList<>();
    }

    public void addData(List<UserResponse.TardinessBean.EntryBean> beanList) {
