...
public class ChatActivity extends BaseActivity implements ChatContract.View, ChatContract.ViewSendMessage,
    ...
    private void showAttentionCalification() {
        ...
        btnSendCalification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attentionCalificationRequest.setChat_id(Integer.parseInt(PreferencesHeper.getKeyChannelId(NewPortApplication.getAppContext().getApplicationContext())));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnSendMessage) {
            ...
            chatMessageTerminatedPresenter.setMessageTerminated(Integer.parseInt(PreferencesHeper.getKeyChannelId(NewPortApplication.getAppContext().getApplicationContext())));
        }
    }
